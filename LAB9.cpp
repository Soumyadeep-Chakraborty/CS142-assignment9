//range search and count in binary search tree
...
{   int data;
    node *parent; //In BST a node consists of data and address of parent , leftchild and rightchild
    node *left;
    node *right;
